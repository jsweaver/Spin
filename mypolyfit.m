...
%   $Revision: 5.17.4.13 $  $Date: 2010/11/17 11:29:32 $
...
if ~isequal(size(x),size(y))
    ...
    error('MATLAB:polyfit:XYSizeMismatch','MATLAB:polyfit:XYSizeMismatch')
end
...
if size(R,2) > size(R,1)
   ...
   warning('MATLAB:polyfit:PolyNotUnique','MATLAB:polyfit:PolyNotUnique')
